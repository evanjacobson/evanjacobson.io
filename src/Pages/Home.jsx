...
const ABOUT_PARAGRAPHS = [
    ...
    // <>The common thread across all of my work has been confronting fundamental issues with agent reliability. How do you give agents what they need to make the right choices on open-ended problems? <Link to="/?project=beads" className="text-green-400 hover:text-green-300 transition-colors">Beads</Link> — structured memory and task decomposition for AI agents — is a critical step, solving the problem of agents getting lost in long-running plans. But how do you enforce quality controls at the implementation level — catch the silent data corruption, the resource leaks, the security holes where agents bypass their own guardrails? </>,
];
